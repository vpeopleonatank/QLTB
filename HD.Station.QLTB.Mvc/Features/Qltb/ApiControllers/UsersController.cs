...
namespace HD.Station.Qltb.Mvc.ApiControllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(IDeviceManagement deviceManagement, IPasswordHasher passwordHasher, IJwtTokenGenerator jwtTokenGenerator, IUserManagement userManagement)
        {
